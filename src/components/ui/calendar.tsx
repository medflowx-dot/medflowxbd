...
function CustomCaption({ displayMonth }: CaptionProps) {
  ...
  return (
    <div className="flex items-center justify-between gap-2 px-1">
      ...
      >
        <SelectTrigger className="h-8 w-[110px] text-sm font-medium border-0 bg-transparent hover:bg-accent focus:ring-0">
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
          {months.map((month) => (
      ...
      >
        <SelectTrigger className="h-8 w-[80px] text-sm font-medium border-0 bg-transparent hover:bg-accent focus:ring-0">
          <SelectValue />
        </SelectTrigger>
