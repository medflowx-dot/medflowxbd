...
export const bn: TranslationKeys = {
  ...
  suppliers: {
    ...
    allPaymentsToSuppliers: 'সরবরাহকারীদের সব পেমেন্ট',
    paymentsFound: 'টি পেমেন্ট পাওয়া গেছে',
    paymentsLabel: 'টি পেমেন্ট',
    noPaymentsMatch: 'আপনার ফিল্টারের সাথে কোনো পেমেন্ট মেলেনি।',
    clearFilters: 'ক্লিয়ার',
    searchPayments: 'পেমেন্ট খুঁজুন...',
    filterByDate: 'তারিখ দিয়ে ফিল্টার',
    filterByType: 'ধরন দিয়ে ফিল্টার',
    filterBySupplier: 'সরবরাহকারী দিয়ে ফিল্টার',
    allTime: 'সব সময়',
    today: 'আজ',
    thisWeek: 'এই সপ্তাহ',
    thisMonth: 'এই মাস',
  ...
  customerDues: {
    ...
    prescriptionMedicines: 'নিয়মিত ঔষধ',
    newPrescription: 'নতুন প্রেসক্রিপশন',
    addMedicine: 'ঔষধ যোগ করুন',
    noPrescriptions: 'কোনো প্রেসক্রিপশন নেই',
    addPrescriptionHint: 'কাস্টমারের প্রেসক্রিপশন যোগ করুন',
    medicineName: 'ঔষধ',
    dosage: 'ডোজ',
    frequency: 'সময়',
    duration: 'কতদিন',
    medicines: 'ঔষধ',
    noMedicinesYet: 'এখনো কোনো ঔষধ যোগ হয়নি',
    status: 'স্ট্যাটাস',
    active: 'সক্রিয়',
    inactive: 'নিষ্ক্রিয়',
    ...
    doctorNamePlaceholder: 'যেমন: ডা. মোহাম্মদ আলী',
    prescriptionDate: 'প্রেসক্রিপশনের তারিখ',
    searchMedicine: 'ঔষধ খুঁজুন বা টাইপ করুন...',
    typeCustomName: 'নতুন ঔষধ যোগ করতে নাম লিখে Enter দিন',
    dosagePlaceholder: 'যেমন: ১০ মিগ্রা, ১ টা করে',
    selectFrequency: 'সিলেক্ট করুন',
    selectDuration: 'সিলেক্ট করুন',
    prescriptionNotes: 'নোট',
    prescriptionNotesPlaceholder: 'অতিরিক্ত তথ্য...',
    medicineNotes: 'নোট',
    medicineNotesPlaceholder: 'বিশেষ নির্দেশনা...',
    createAndAddMedicines: 'তৈরি করুন',
    deletePrescription: 'প্রেসক্রিপশন মুছবেন?',
    deletePrescriptionConfirm: 'এই প্রেসক্রিপশন এবং এর সব ঔষধ মুছে যাবে।',
    deleteMedicine: 'ঔষধ মুছবেন?',
    deleteMedicineConfirm: 'এই ঔষধটি প্রেসক্রিপশন থেকে মুছে যাবে।',
  ...
  medicineReference: {
    title: 'ঔষধ রেফারেন্স',
    subtitle: 'ঔষধের দাম, জেনেরিক এবং বিকল্প ব্র্যান্ড খুঁজুন',
    searchPlaceholder: 'ঔষধের নাম বা জেনেরিক খুঁজুন...',
    popularSearches: 'জনপ্রিয়:',
    filters: 'ফিল্টার',
    clearFilters: 'ক্লিয়ার',
    allForms: 'সব ফর্ম',
    allClasses: 'সব ক্লাস',
    allManufacturers: 'সব প্রস্তুতকারক',
    totalMedicines: 'মোট ঔষধ',
    totalGenerics: 'জেনেরিক',
    manufacturers: 'প্রস্তুতকারক',
    searchTitle: 'ঔষধ খুঁজুন',
    searchDescription: 'নাম, জেনেরিক বা ফিল্টার দিয়ে ঔষধ খুঁজুন',
    startSearching: 'খোঁজা শুরু করুন',
    searchPrompt: 'ঔষধের নাম লিখুন বা ফিল্টার ব্যবহার করুন',
    showingResults: 'দেখাচ্ছে',
    results: 'ফলাফল',
    noResults: 'কোনো ঔষধ পাওয়া যায়নি',
    ...
    dosageForm: 'ফর্ম',
    strength: 'শক্তি',
    drugClass: 'ড্রাগ ক্লাস',
    priceInfo: 'দামের তথ্য',
    perStrip: 'প্রতি পাতা',
    packSize: 'প্যাক সাইজ',
    indication: 'ব্যবহার',
    alsoAvailableAs: 'অন্যান্য ফর্মে পাওয়া যায়',
    viewAlternateBrands: 'বিকল্প ব্র্যান্ড দেখুন',
    alternateBrands: 'বিকল্প ব্র্যান্ড',
    priceLowHigh: 'দাম ↑',
    priceHighLow: 'দাম ↓',
    name: 'নাম',
    noAlternatesFound: 'কোনো বিকল্প ব্র্যান্ড পাওয়া যায়নি',
    cheapest: 'সস্তা',
    showingBrands: 'দেখাচ্ছে',
    brands: 'ব্র্যান্ড',
    sortedBy: 'সর্ট:',
    ...
    dosage: 'মাত্রা',
    safety: 'সতর্কতা',
    therapeuticClass: 'থেরাপিউটিক ক্লাস',
    pharmacology: 'ফার্মাকোলজি',
    modeOfAction: 'কার্যপ্রণালী',
    storage: 'সংরক্ষণ',
    dosageAdult: 'প্রাপ্তবয়স্কদের মাত্রা',
    dosagePediatric: 'শিশুদের মাত্রা',
    administration: 'সেবনবিধি',
    noDosingInfo: 'মাত্রার তথ্য নেই',
    contraindications: 'প্রতিনির্দেশনা',
    sideEffects: 'পার্শ্বপ্রতিক্রিয়া',
    precautions: 'সতর্কতা',
    drugInteractions: 'ড্রাগ ইন্টারঅ্যাকশন',
    overdoseInfo: 'অতিমাত্রা',
    pregnancyLactation: 'গর্ভাবস্থা ও স্তন্যদান',
    category: 'ক্যাটাগরি',
    noSafetyInfo: 'নিরাপত্তা তথ্য নেই',
  },

  // Login Page
  login: {
    welcome: 'স্বাগতম',
    signInToPharmacy: 'আপনার ফার্মেসি ড্যাশবোর্ডে সাইন ইন করুন',
    mobile: 'মোবাইল',
    email: 'ইমেইল',
    ...
    accountLocked: 'অনেক বার ভুল পাসওয়ার্ড দেওয়া হয়েছে। অ্যাকাউন্ট {minutes} মিনিটের জন্য লক করা হয়েছে।',
    attemptsWarning: 'সতর্কতা: আর {attempts} বার ভুল চেষ্টায় অ্যাকাউন্ট লক হবে।',
    waitMinutes: '{minutes} মিনিট অপেক্ষা করুন',
    // PIN
    pinSetupTitle: '৪-ডিজিট পিন সেটআপ করুন',
    pinConfirmTitle: 'পিন নিশ্চিত করুন',
    pinSetupDesc: 'দ্রুত লগইনের জন্য একটি পিন সেট করুন',
    enterPinAgain: 'আবার আপনার পিন লিখুন',
    next: 'পরবর্তী',
    setPin: 'পিন সেট করুন',
    skipForNow: 'পরে করব',
    loginWithPin: 'পিন দিয়ে লগইন করুন',
    enterYour4DigitPin: 'আপনার ৪-ডিজিট পিন লিখুন',
    loginWithPassword: 'পাসওয়ার্ড দিয়ে লগইন করুন',
    // Errors
    serverConnectionError: 'সার্ভারের সাথে সংযোগ করা যাচ্ছে না। ইন্টারনেট চেক করুন।',
    loginFailed: 'লগইন ব্যর্থ',
    invalidCredentials: 'ভুল মোবাইল নম্বর বা পাসওয়ার্ড',
    invalidEmailCredentials: 'ভুল ইমেইল বা পাসওয়ার্ড',
    pinMismatch: 'পিন মিলছে না। আবার চেষ্টা করুন।',
